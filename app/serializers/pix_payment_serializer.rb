  ...
  def self.render(pix_payment)
    {
      ...
      pix_key: Privacy::Redactor.contact(pix_payment.pix_key),
      receiver_name: Privacy::Redactor.name(pix_payment.receiver_name),
      ...
      metadata: Privacy::Redactor.metadata(pix_payment.metadata),
