module MedCases
  class Accept
    ...
    def initialize(organization:, med_case:, correlation_id: nil)
    ...
    def call
      ...
      ActiveRecord::Base.transaction do
        ...
        med_case.update!(status: "refunded", refund:, resolved_at: Time.current)
    ...
    attr_reader :organization, :med_case, :correlation_id
  end
end
