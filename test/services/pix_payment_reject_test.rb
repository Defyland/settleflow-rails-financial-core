...
class PixPaymentRejectTest < ActiveSupport::TestCase
  ...
  test "only rejects pending-review Pix payments" do
    pix_payment = build_pix_payment(organization: @organization, wallet: @wallet, status: "created")
